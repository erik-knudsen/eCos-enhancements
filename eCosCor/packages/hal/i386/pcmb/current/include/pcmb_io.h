...
//
// Author(s):    proven
// Contributors: proven, jskov, pjo, eak
// Date:         1999-10-15
...
//We have support for either ISA IDE or PCI IDE and only one set (two IDE channels
// - primary and secondary - with two devices per channel for a total of four IDE
//devices).
#ifndef CYGHWR_HAL_I386_PC_PCI_IDE
#define HAL_IDE_NUM_CONTROLLERS 2		//Must be 2 in the current implementation.
